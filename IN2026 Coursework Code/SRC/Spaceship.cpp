...
void Spaceship::Reset()
{
    ...
    //Ensures acceleration is also zero'd
...
void Spaceship::Thrust(float t)
{
    ...
    mAcceleration.x = (mThrust * cos(DEG2RAD * mAngle)) * 2;
    mAcceleration.y = (mThrust * sin(DEG2RAD * mAngle)) * 3;
}
...
void Spaceship::Shoot(void)
{
    ...
    //Sets the scale of the bullet relative to its size which can be changed by powerups
    bullet->SetScale(mBulletRadius / 2.0f);
